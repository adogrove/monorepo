...
A user resolver is a class that implements `UserResolver` interface.
...
Please refer to the [General Configuration](../configuration/general-configuration#user-resolver) section for more information.
